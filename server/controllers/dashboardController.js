...
export async function getDashboard(req, res, next) {
  try {
    ...
    const [newJobsToday, strongMatches, prepared, sent, topMatchRecords, recentApplications] = await Promise.all([
    ...
    res.json({ metrics: { newJobsToday, strongMatches, prepared, sent }, topMatches, recentApplications })
